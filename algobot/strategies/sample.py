...
class SampleStrategy(Strategy):
    ...
    def get_trend(self, data: Union[List[dict], Data] = None, log_data: bool = False):
        ...
        if (
            log_data
        ):  # If you want to log the data, set advanced logging to True. Note this will write a lot of data.
