...
from algobot.helpers import PATHS, open_folder
...
def create_action_slots(gui):
    ...
    gui.openOptimizerResultsFolderAction.triggered.connect(
        lambda: open_folder(PATHS.get_optimizer_results_dir())
    )
    gui.openVolatilityResultsFolderAction.triggered.connect(
        lambda: open_folder(PATHS.get_volatility_results_dir())
    )
    gui.openLogFolderAction.triggered.connect(lambda: open_folder(PATHS.get_log_dir()))
    gui.openCsvFolderAction.triggered.connect(lambda: open_folder(PATHS.get_csv_dir()))
    gui.openDatabasesFolderAction.triggered.connect(lambda: open_folder(PATHS.get_database_dir()))
    gui.openCredentialsFolderAction.triggered.connect(lambda: open_folder(PATHS.get_credentials_dir()))
    gui.openConfigurationsFolderAction.triggered.connect(lambda: open_folder(PATHS.get_configuration_dir()))
