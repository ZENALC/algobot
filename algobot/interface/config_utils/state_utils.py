...
def save_state(config_obj):
    ...
    config = {
        ...
        "optimizerStrategyInterval": int(
            config_obj.optimizerStrategyIntervalCombobox.currentIndex()
        ),
        "optimizerStrategyEndInterval": int(
            config_obj.optimizerStrategyIntervalEndCombobox.currentIndex()
        ),
        "backtestInterval": int(config_obj.backtestIntervalComboBox.currentIndex()),
        "backtestStrategyInterval": int(
            config_obj.backtestStrategyIntervalCombobox.currentIndex()
        ),
    }
